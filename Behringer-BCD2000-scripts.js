...
BehringerBCD2000.effectUnit = new components.EffectUnit([1, 3]);
BehringerBCD2000.effectUnit.enableButtons[1].midi = [0x90, 0x1F];
BehringerBCD2000.effectUnit.enableButtons[2].midi = [0x90, 0x20];
BehringerBCD2000.effectUnit.enableButtons[3].midi = [0x90, 0x21];
BehringerBCD2000.effectUnit.knobs[1].midi = [0xB0, 0x0D];
BehringerBCD2000.effectUnit.knobs[2].midi = [0xB0, 0x0E];
BehringerBCD2000.effectUnit.knobs[3].midi = [0xB0, 0x0F];
BehringerBCD2000.effectUnit.dryWetKnob.midi = [0xB0, 0x10];
BehringerBCD2000.effectUnit.effectFocusButton.midi = [0x90, 0x22];
BehringerBCD2000.effectUnit.init();
